# @lambrioanpm/aspernatur-minus-beatae

[![CI](https://github.com/lambrioanpm/aspernatur-minus-beatae/workflows/CI/badge.svg)](https://github.com/lambrioanpm/aspernatur-minus-beatae/actions/workflows/ci.yml)
[![NPM version](https://img.shields.io/npm/v/@lambrioanpm/aspernatur-minus-beatae.svg?style=flat)](https://www.npmjs.com/package/@lambrioanpm/aspernatur-minus-beatae)
...
```
npm i @lambrioanpm/aspernatur-minus-beatae
```

## Compatibility with @fastify/multipart
`@lambrioanpm/aspernatur-minus-beatae` and [`@fastify/multipart`](https://github.com/fastify/fastify-multipart) should not be registered as sibling plugins nor should they be registered in plugins which have a parent-child relationship.`<br>` The two plugins are incompatible, in the sense that the behavior of `@lambrioanpm/aspernatur-minus-beatae` might not be the expected one when the above-mentioned conditions are not respected.`<br>` This is due to the fact that `@fastify/multipart` consumes the multipart content by parsing it, hence this content is not forwarded to the target service by `@lambrioanpm/aspernatur-minus-beatae`.`<br>`
...
proxy.register(require('@lambrioanpm/aspernatur-minus-beatae'), {
